#!/usr/bin/env python3
"""
Apply PCS GC winner time corrections to giro_races_summary_overrides.json.

Reads giro_gc_time_corrections.json (year -> pcs_winner_seconds from PCS),
computes corrected slowestFinisherTimeSeconds as winner + max_gap from DB,
and merges into giro_races_summary_overrides.json.

Run after check_giro_gc_times.py has produced giro_gc_time_corrections.json.
"""
...
CORRECTIONS_PATH = os.path.join(HERE, "giro_gc_time_corrections.json")
