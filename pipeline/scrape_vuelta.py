...
Produces per-stage JSON in vuelta_scrapes/YEAR/stage_N.json, compatible with
ingest_race.py --race vuelta and build_vuelta_points.py.

Usage:
  python3 scrape_vuelta.py 2025
